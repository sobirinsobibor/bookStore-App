...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <div class="mt-3">
          ...
          ?>
            <ul class="list-group" style="width : 60%;">
                <li class="list-group-item active" aria-current="true">Informasi Buku</li>
                <li class="list-group-item">Kode Buku     : <?=$row['kode']?></li>
                <li class="list-group-item">Judul Buku    : <?=$row['judul']?></li>
                <li class="list-group-item">Halaman buku  : <?=$row['halaman']?> halaman</li>
                <li class="list-group-item">Tahun terbit  : <?=$row['terbit']?></li>
              </ul>
          <?php
            endforeach;
          ?>
        ...
        <div class="mt-3">
            <button type="button" class="btn btn-dark" onclick="mainMenu()"  >Back</button>
        </div>
    </div>
